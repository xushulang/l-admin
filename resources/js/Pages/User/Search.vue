...
<template>
    <NCollapseTransition :show="showUserSearchForm">
        <NForm
            ref="formRef"
            :model
            :rules
        ...
        >
            <NFormItem first :label="$t('Keywords')" path="search">
                <NInput v-model:value="model.search" :placeholder="$t('Please enter :name', { name: $t('Keywords') })" />
            </NFormItem>
